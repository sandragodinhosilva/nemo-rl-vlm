#!/bin/bash
#SBATCH --job-name=sft-vlm-qwen35-27b-oracle-obs-cat-reasoning
#SBATCH --nodes=1
...
set -euo pipefail
SCRIPT_PATH="/home/sgsilva/nemo-rl-vlm/examples/configs/recipes/vlm/slurm_multinode_worker_qwen35_27b_oracle_obs_cat_reasoning.sh"
...
if [ "$NODE_RANK" -eq 0 ]; then
    ...
    SFT_CONFIG="${CONFIG:-examples/configs/sft_vlm_qwen35_27b_oracle_obs_cat_reasoning_megatron.yaml}"
